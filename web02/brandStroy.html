...
<div class="content container-fluid bg-light">
    <div class="page_wrap">    
        <div class="content">
            <img src="./img/brand/story/brand_story_img1.jpg" class="pic1" alt="사진1">
            <img src="./img/brand/story/brand_story_img2.jpg" alt="사진2">
            <img src="./img/brand/story/brand_story_img3.jpg" alt="사진3">
            <img src="./img/brand/story/brand_story_img4.png" class="pic4" alt="사진4">
        </div>
    </div> 
</div>
</div>   
