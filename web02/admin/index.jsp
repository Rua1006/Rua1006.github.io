...
<head>
    ...
    .row {width: 100%; padding: 0; height: 90%;}
...
<div class="content container-fluid" id="page1">
    <div class="product" id="content">
		...
		<% } %>
		<h2 class="pb-2 border-bottom">관리자페이지에 오신걸 환영합니다</h2>
		<div class="row row-cols-1 row-cols-sm-2 g-4">
			<!-- <div class="d-flex flex-column align-items-start row-cols-1 gap-2">
	        ...
	        <div class="d-flex flex-column gap-2 mem">
	        ...
	        <div class="d-flex flex-column gap-2 bod">
		        <h4 class="fw-semibold mb-0">Featured title</h4>
		        <p class="text-muted">Paragraph of text beneath the heading to explain the heading.</p>
	        </div>
	        <div class="d-flex flex-column gap-2 pro">
		        <h4 class="fw-semibold mb-0">Featured title</h4>
		        <p class="text-muted">Paragraph of text beneath the heading to explain the heading.</p>
	        </div>
	        <div class="d-flex flex-column gap-2 qna">
		        <h4 class="fw-semibold mb-0">Featured title</h4>
		        <p class="text-muted">Paragraph of text beneath the heading to explain the heading.</p>
	        </div>
    	</div>	 -->
