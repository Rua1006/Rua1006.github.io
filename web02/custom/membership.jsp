...
<head>
    ...
    .subtitle {font-weight: 600; font-size: 30px; margin-top: 30px; text-align: center; padding-bottom: 20px;}
    .agree_fr { width: 900px; white-space:pre-wrap; margin: 30px auto;  padding: 24px; border:2px solid #eee; height:600px; overflow-y:auto; font-size: 20px; text-align: justify; word-break: keep-all;}
    
    /*btn*/
    .btn-group {width: 100%;}
    #button-addon2 {border-top-right-radius: 0.375rem; border-bottom-right-radius: 0.375rem;}
    .form-check { width: 68%; margin:10px auto; padding: 24px; font-size: 20px;}
    .form-check-label {float: left;}
    .btn {clear: both; width: 20%; display: block; margin: 0 auto; margin-top: 40px; font-size: 25px;}
...
<div class="content container-fluid bg-light">
    <div class="page_wrap bg-light">    
        <div class="container subtitle ">
            <div class="container subtitle">
                <div class="list-title font--kr">회원 이용 약관</strong></div>
            </div>
            <div class="agree_fr ">
제1장 총칙
...
제33조(분쟁의 해결) "회사"는 분쟁이 발생하였을 경우에 "이용자"가 제기하는 정당한 의견이나 불만을 반영하여 적절하고 신속한 조치를 취합니다. 다만, 신속한 처리가 곤란한 경우에 "회사"는 "이용자"에게 그 사유와 처리일정을 통보합니다.                     
        ...
        <div class="form-check mb-3">
 	       <input class="form-check-input" type="checkbox" id="inlineFormCheck" name="inlineFormCheck">
    	    <label class="form-check-label" for="inlineFormCheck">이용약관 동의</label>
        </div>
        <div class="button pb-5">
            <button type="button" id="in_btn1" class="btn btn-dark">회원가입으로 이동</button>    
        </div>
</div>
<script>
	var inlineFormCheck = document.getElementById("inlineFormCheck");
