...
<head>
    ...
    .title {font-weight: 600; margin-bottom: 20px;}
    a {text-decoration: none;}
    .form {margin-top: 30px; width: 600px;}
    .row {width: 50%; padding: 0; margin-left: 30%}
    ...
    .btn-group {width: 100%; float: right; padding-left: calc(var(--bs-gutter-x) * .5);}
	...
	<div class="row" id="content_row">
		...
		<h2 class="title">제품 구매하기</h2>
				...
				<table class="table">
					<tbody>
						<tr>
							...
							<input type="text" name="postcode" id="postcode" style="width:200px;float:left;margin-right:20px;" placeholder="우편번호" class="form-control" required>
							<button type="button" id="post_btn" onclick="findAddr()" class="btn btn-dark" style="margin-bottom: 20px;">우편번호 검색</button>
							</td>
						</tr>
						<tr>
							<th>받는 사람 연락처</th>
			...
			<div class="btn-group">
				...
				<a href="<%=request.getContextPath() %>/GetProductWearingCtrl?proNo=<%=vo.getProNo() %>" class="btn btn-warning">제품 입고</a>
				<% } %>
			</div>
		</main>
	</div>
