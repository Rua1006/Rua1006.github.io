...
<head>
    ...
    .row {width: 80%; padding: 0; margin-left: 10%;}
    ...
    .btn-group {width: 45%; float: right; padding-left: calc(var(--bs-gutter-x) * .5);}
	...
	<div class="row" id="content_row">
		...
		<h2 class="title">구매 상세 내역</h2>
			...
			<div class="btn-group">
				...
				<a href="<%=request.getContextPath() %>/DeleteSalesCtrl?saleNo=<%=vo.getSaleNo() %>" class="btn btn-danger">결제 취소</a>
