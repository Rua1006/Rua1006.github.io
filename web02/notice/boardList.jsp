...
<head>
    ...
    .table {margin-left: 40%; text-align: center;}
    ...
    /*btn*/
    .btn {margin-top: 0.5em; float: left;}
    .btn-group {width: 25%; float: right; padding-left: calc(var(--bs-gutter-x) * .5);}
...
<div class="content container-fluid" id="page1">
    <div class="product" id="content">
		...
		<% } %>
		<h2 class="pb-2 border-bottom title">공지사항</h2>
		...
		<% if(sid!=null && sid.equals("admin")) { %>
		<div class="btn-group">
			<a href="<%=request.getContextPath()%>/notice/insertBoard.jsp" class="btn btn-dark">글 작성</a>
		</div>
		<%} %>
		</main>
		</div>
