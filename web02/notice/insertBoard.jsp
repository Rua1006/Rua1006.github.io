		...
		<form name="form1" id="form1" action="<%=request.getContextPath()%>/InsertBoardCtrl" method="post">
			<table class="table">
				<tbody>
					...
					<tr>
						<th>내용입력</th>
						<td><textarea rows="10" cols="8" name="content" id="content" class="form-control" required></textarea></td>
					</tr>
					<tr>
						<th>작성자</th>
			...
			<div class="btn-group">
				<input type="submit" name="submit_button" class="btn btn-dark" value="작성">
				<input type="reset" name="reset_button" class="btn btn-secondary" value="취소">
				<a href="<%=request.getContextPath()%>/GetBoardListCtrl" class="btn btn-dark">글목록</a>
			</div>
		</form>
		</main>
    	</div>
