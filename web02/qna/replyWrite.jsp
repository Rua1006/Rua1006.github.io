...
<head>
    ...
    .btn-group {width: 25%; float: right; padding-left: calc(var(--bs-gutter-x) * .5); padding-right: 1.5rem!important; margin-right: 13.5%}
    ...
    <div class="product" id="content">
		...
		<h2 class="title">답변 쓰기</h2>
			<form name="frm1" id="frm1" action="<%=request.getContextPath() %>/QnaReplyWriteProCtrl.do" method="post">
				...
				<div class="btn-group">
					<button type="submit" class="btn btn-dark">답글 쓰기</button>
