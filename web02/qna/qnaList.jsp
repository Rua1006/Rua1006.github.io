...
<head>
    ...
    .btn-group {width: 25%; margin-left: 87%; padding-left: calc(var(--bs-gutter-x) * .5); padding-right: 1.5rem!important;}
...
<div class="content container-fluid" id="page1">
    <div class="product" id="content">
		...
		<div class="row row-cols-1 row-cols-sm-2 g-4">
			...
			<% if(sid!=null || sid.equals("admin")) { %>
			<div class="btn-group">
				<a href="<%=request.getContextPath() %>/qna/qnaWrite.jsp" class="btn btn-dark">글 등록</a>
			</div>
			<% } %>
    	</div>
	</div>
